...
const UserMockRepository_1 = require("../services/UserMockRepository");
let UserController = class UserController {
    constructor() {
        // TODO - check if in testing mode, switch repository
        this.userRepository = new UserMockRepository_1.UserMockRepository();
    }
    getAll() {
